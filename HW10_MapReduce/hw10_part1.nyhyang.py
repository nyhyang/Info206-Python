...
class UniqueReview(MRJob):
    ...
    def reducer2_count_unique_words(self, review_id, unique_word_counts):
        ...
        #
        ##/
        # not sure how unique_word_counts is link to reducer1 variable
    ...
    def mapper3_aggregate_max(self, review_id, unique_word_count):
        ...
        # the same reducer:
        # yield ["MAX", [ ___ , ___]]
        # this is to combine all the elements [, ] into one key value pair 
        ##/
    ...
    def reducer3_select_max(self, stat, count_review_ids):
        ...
        # number
        #
        #/ max_review is one list 
        max_review = max(count_review_ids)
        yield [max_review[1], max_review[0]]
